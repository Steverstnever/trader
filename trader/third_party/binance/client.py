...
class Client(object):
    ...
    def __init__(self, api_key=None, api_secret=None, requests_params=None, tld='com', slow_network_adjust_ms=1000):
        ...
        self.slow_network_adjust_ms = slow_network_adjust_ms  # FIX: 慢速网络签名时的时间校准
    ...
    def _init_session(self):
        ...
        session.headers.update({'Accept': 'application/json',
                                'User-Agent': 'binance/python',  # TODO: 修改为其它 agent-str?
    ...
    def _request(self, method, uri, signed, force_params=False, **kwargs):
        ...
        if signed:
            # generate signature
            # TODO: BUGFIX: kwargs['data']['timestamp'] = int(time.time() * 1000)
            kwargs['data']['timestamp'] = int(time.time() * 1000 - self.slow_network_adjust_ms)
